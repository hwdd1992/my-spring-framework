 ...
 * An instance of this class wrapping {@code Foo.class} will return the constant value of 66 from
 * its {@code asNumber} method given the argument {@code "CONSTANT1"}.
 *
 * <p>This class is ideal for use in PropertyEditors, enabling them to
 * recognize the same names as the constants themselves, and freeing them from maintaining their own
 * mapping.
 *
 * @author Rod Johnson
...
public class Constants {
   ...
   * in accordance with the standard Java convention for constant values (i.e. all uppercase). The
   * supplied {@code namePrefix} will be uppercased (in a locale-insensitive fashion) prior to the
   * main logic of this method kicking in.
   *
   ...
   * <p>Note that this method assumes that constants are named
   * in accordance with the standard Java convention for constant values (i.e. all uppercase). The
   * supplied {@code nameSuffix} will be uppercased (in a locale-insensitive fashion) prior to the
   * main logic of this method kicking in.
   *
   ...
   * Example: "imagesize" -> "IMAGESIZE".<br> Example: "ImageSize" -> "_IMAGE_SIZE".<br> Example:
