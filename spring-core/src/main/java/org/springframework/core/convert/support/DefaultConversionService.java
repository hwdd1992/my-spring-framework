 ...
 * {@link #addDefaultConverters(ConverterRegistry)} utility method for ad-hoc use against any {@code
...
public class DefaultConversionService extends GenericConversionService {
   ...
   * {@code ConversionService} instances for customization purposes. This accessor is only meant as
   * a fallback for code paths which need simple type coercion but cannot access a longer-lived
  ...
  public static void addDefaultConverters(ConverterRegistry converterRegistry) {
    ...
    if (javaUtilOptionalClassAvailable) {
      converterRegistry
          .addConverter(new ObjectToOptionalConverter((ConversionService) converterRegistry));
    }
  }
  ...
  private static void addScalarConverters(ConverterRegistry converterRegistry) {
    ...
    converterRegistry
        .addConverter(new EnumToStringConverter((ConversionService) converterRegistry));

    converterRegistry.addConverterFactory(new IntegerToEnumConverterFactory());
    converterRegistry
        .addConverter(new EnumToIntegerConverter((ConversionService) converterRegistry));
