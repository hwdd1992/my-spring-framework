 ...
 * physical form, but a URL or File handle can just be returned for certain resources. The actual
...
public interface Resource extends InputStreamSource {
   ...
   * note that actual content reading may still fail when attempted. However, a value of {@code
   * false} is a definitive indication that the resource content cannot be read.
   *
   * @see #getInputStream()
   */
  boolean isReadable();
