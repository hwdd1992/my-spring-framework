...
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements
   ...
   * any sort of extended singleton creation phase. In particular, subclasses should <i>not</i> have
   * their own mutexes involved in singleton creation, to avoid the potential for deadlocks in
   * lazy-init situations.
   */
