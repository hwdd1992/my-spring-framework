...
public class BeanDefinitionParserDelegate {
   ...
   * 'beans' element use cases by falling back to <literal>parentDefaults</literal> in case the
  ...
  public Map<Object, Object> parseMapElement(Element mapEle, BeanDefinition bd) {
    ...
    for (Element entryEle : entryEles) {
      ...
      if (hasValueAttribute) {
        ...
        value = buildTypedStringValueForMap(entryEle.getAttribute(VALUE_ATTRIBUTE), valueType,
            entryEle);
  ...
  public BeanDefinitionHolder decorateIfRequired(
    ...
    if (!isDefaultNamespace(namespaceUri)) {
      ...
      } else if (namespaceUri != null && namespaceUri
          .startsWith("http://www.springframework.org/")) {
        error("Unable to locate Spring NamespaceHandler for XML schema namespace [" + namespaceUri
            + "]", node);
      } else {
   ...
   * Subclasses may override the default implementation to provide a different mechanism for getting
   * the local name.
   *
