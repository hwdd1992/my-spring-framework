...
public class BeanWrapperImpl extends AbstractNestablePropertyAccessor implements BeanWrapper {
  ...
  private Property property(PropertyDescriptor pd) {
    ...
    return new Property(gpd.getBeanClass(), gpd.getReadMethod(), gpd.getWriteMethod(),
        gpd.getName());
  }
  ...
  public PropertyDescriptor getPropertyDescriptor(String propertyName)
    ...
    PropertyDescriptor pd = nestedBw.getCachedIntrospectionResults()
        .getPropertyDescriptor(finalPath);
    if (pd == null) {
      throw new InvalidPropertyException(getRootClass(), getNestedPath() + propertyName,
          "No property '" + propertyName + "' found");
    }
  ...
  private class BeanPropertyHandler extends PropertyHandler {
    ...
    public Object getValue() throws Exception {
      ...
      if (!Modifier.isPublic(readMethod.getDeclaringClass().getModifiers()) && !readMethod
          .isAccessible()) {
    ...
    public void setValue(final Object object, Object valueToApply) throws Exception {
      ...
      if (!Modifier.isPublic(writeMethod.getDeclaringClass().getModifiers()) && !writeMethod
          .isAccessible()) {
        if (System.getSecurityManager() != null) {
          AccessController.doPrivileged(new PrivilegedAction<Object>() {
            @Override
