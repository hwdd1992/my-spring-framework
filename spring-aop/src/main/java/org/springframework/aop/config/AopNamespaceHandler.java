 ...
 * {@code <aop:config>} tag. A {@code config} tag can include nested {@code pointcut}, {@code
 * advisor} and {@code aspect} tags.
 *
 ...
 * automatically. The {@code advisor} tag supports both in-line and referenced {@link
 * org.springframework.aop.Pointcut Pointcuts}:
 *
 * <pre class="code">
