...
public class AspectJExpressionPointcut extends AbstractExpressionPointcut
  ...
  private transient Map<Method, ShadowMatch> shadowMatchCache = new ConcurrentHashMap<Method, ShadowMatch>(
      32);
   ...
   */
  public AspectJExpressionPointcut(Class<?> declarationScope, String[] paramNames,
      Class<?>[] paramTypes) {
  ...
  public boolean matches(Class<?> targetClass) {
    ...
    try {
      try {
        ...
        logger
            .debug("PointcutExpression matching rejected target class - trying fallback expression",
                ex);
  ...
  public boolean matches(Method method, Class<?> targetClass, boolean beanHasIntroductions) {
    ...
    if (shadowMatch.alwaysMatches()) {
      ...
      return (!walker.testsSubtypeSensitiveVars() || walker
  ...
  public boolean matches(Method method, Class<?> targetClass, Object... args) {
    checkReadyToMatch();
    ShadowMatch shadowMatch = getShadowMatch(AopUtils.getMostSpecificMethod(method, targetClass),
        method);
