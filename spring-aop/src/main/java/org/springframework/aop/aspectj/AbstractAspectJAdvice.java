...
public abstract class AbstractAspectJAdvice implements Advice, AspectJPrecedenceInformation,
  ...
  private void bindArgumentsByName(int numArgumentsExpectingToBind) {
    ...
    if (this.argumentNames != null) {
      ...
      throw new IllegalStateException(
          "Advice method [" + this.aspectJAdviceMethod.getName() + "] " +
   ...
   */
  protected Object[] argBinding(JoinPoint jp, JoinPointMatch jpMatch, Object returnValue,
      Throwable ex) {
    calculateArgumentBindings();
  ...
  protected Object invokeAdviceMethod(JoinPoint jp, JoinPointMatch jpMatch, Object returnValue,
      Throwable t)
      throws Throwable {
  ...
  protected Object invokeAdviceMethodWithGivenArgs(Object[] args) throws Throwable {
    ...
    try {
      ...
      return this.aspectJAdviceMethod
          .invoke(this.aspectInstanceFactory.getAspectInstance(), actualArgs);
  ...
  private void readObject(ObjectInputStream inputStream)
    ...
    try {
      this.aspectJAdviceMethod = this.declaringClass
          .getMethod(this.methodName, this.parameterTypes);
