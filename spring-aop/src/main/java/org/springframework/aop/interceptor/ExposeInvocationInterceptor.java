 ...
 * not normally know about Spring AOP, as this creates a dependency on Spring API. Target objects
...
public class ExposeInvocationInterceptor implements MethodInterceptor, PriorityOrdered,
    Serializable {
