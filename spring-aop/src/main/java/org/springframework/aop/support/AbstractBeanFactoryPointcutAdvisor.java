 ...
 * (if running within a BeanFactory) increases loose coupling at initialization time, in order to
 * not initialize the advice object until the pointcut actually matches.
 *
...
public abstract class AbstractBeanFactoryPointcutAdvisor extends AbstractPointcutAdvisor implements
    BeanFactoryAware {
   ...
   * of this advisor's advice. This advisor will only ever obtain at most one single instance of the
   * advice bean, caching the instance for the lifetime of the advisor.
   *
   * @see #getAdvice()
   */
