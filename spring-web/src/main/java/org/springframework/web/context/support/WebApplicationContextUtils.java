 ...
 * many web frameworks, either part of Spring or available as an external library. This helper class
...
public abstract class WebApplicationContextUtils {
   ...
   * controlled through its {@code publishContext} property, which is {@code true} by default but
   * can be selectively switched to only publish a single context despite multiple {@code
  ...
  public static void registerEnvironmentBeans(
      ConfigurableListableBeanFactory bf, ServletContext servletContext,
      ServletConfig servletConfig) {

    if (servletContext != null && !bf
        .containsBean(WebApplicationContext.SERVLET_CONTEXT_BEAN_NAME)) {
      bf.registerSingleton(WebApplicationContext.SERVLET_CONTEXT_BEAN_NAME, servletContext);
    }

    if (servletConfig != null && !bf
   ...
   * of times but will perform replacement of stub property sources with their corresponding actual
   * property sources once and only once.
   *
   * @param propertySources the {@link MutablePropertySources} to initialize (must not be {@code
   * null})
   ...
   * {@link StandardServletEnvironment#SERVLET_CONFIG_PROPERTY_SOURCE_NAME servlet config property
   * source} has already been initialized)
  ...
  public static void initServletPropertySources(
    ...
    if (servletContext != null && propertySources
      ...
      propertySources.replace(StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME,
          new ServletContextPropertySource(
              StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME, servletContext));
    }
    if (servletConfig != null && propertySources
      ...
      propertySources.replace(StandardServletEnvironment.SERVLET_CONFIG_PROPERTY_SOURCE_NAME,
          new ServletConfigPropertySource(
   ...
   */
  @SuppressWarnings("serial")
  private static class ResponseObjectFactory implements ObjectFactory<ServletResponse>,
      Serializable {
  ...
  private static class FacesDependencyRegistrar {
    ...
    public static void registerFacesDependencies(ConfigurableListableBeanFactory beanFactory) {
      beanFactory
          .registerResolvableDependency(FacesContext.class, new ObjectFactory<FacesContext>() {
            @Override
      ...
      beanFactory.registerResolvableDependency(ExternalContext.class,
