...
/**
 * {@link CacheManager} implementation that lazily builds {@link GuavaCache} instances for each
 ...
 * Guava {@link CacheBuilder} or {@link CacheBuilderSpec}, passed into this CacheManager through
 * {@link #setCacheBuilder}/{@link #setCacheBuilderSpec}. A {@link CacheBuilderSpec}-compliant
 * expression value can also be applied via the {@link #setCacheSpecification "cacheSpecification"}
 * bean property.
 *
...
public class GuavaCacheManager implements CacheManager {
  ...
  /**
   * Construct a dynamic GuavaCacheManager, lazily creating cache instances as they are being
   * requested.
   */
  ...
  /**
   * Set the Guava CacheBuilderSpec to use for building each individual {@link GuavaCache}
   * instance.
   *
   * @see #createNativeGuavaCache
  ...
  /**
   * Set the Guava cache specification String to use for building each individual {@link GuavaCache}
   * instance. The given value needs to comply with Guava's {@link CacheBuilderSpec} (see its
   * javadoc).
   *
   * @see #createNativeGuavaCache
  ...
  /**
   * Set the Guava CacheLoader to use for building each individual {@link GuavaCache} instance,
   * turning it into a LoadingCache.
   *
   * @see #createNativeGuavaCache
