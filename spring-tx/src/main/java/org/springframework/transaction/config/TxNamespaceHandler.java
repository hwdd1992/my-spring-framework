 ...
 * Spring transaction management facilities and offers two approaches to declaratively manage
 * transactions.
 *
 * <p>One approach uses transaction semantics defined in XML using the
 * {@code <tx:advice>} elements, the other uses annotations in combination with the {@code
 * <tx:annotation-driven>} element. Both approached are detailed to great extent in the Spring
 * reference manual.
 *
 * @author Rob Harrop
