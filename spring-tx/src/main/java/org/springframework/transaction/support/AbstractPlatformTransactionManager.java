...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager,
   ...
   * PROPAGATION_REQUIRED or PROPAGATION_SUPPORTS encountering an existing transaction), this outer
   ...
   * PROPAGATION_REQUIRED or PROPAGATION_SUPPORTS encountering an existing transaction) fails, the
