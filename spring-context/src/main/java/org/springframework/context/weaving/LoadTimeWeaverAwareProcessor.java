 ...
 * will automatically register this with their underlying {@link BeanFactory bean factory}, provided
 * that a default {@code LoadTimeWeaver} is actually available.
 *
...
public class LoadTimeWeaverAwareProcessor implements BeanPostProcessor, BeanFactoryAware {
   ...
   * {@code LoadTimeWeaver} will be auto-retrieved from the containing {@link BeanFactory},
   ...
   * the given {@link BeanFactory}, expecting a bean named {@link ConfigurableApplicationContext#LOAD_TIME_WEAVER_BEAN_NAME
   * "loadTimeWeaver"}.
   *
